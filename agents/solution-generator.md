...
**怎么写反题**：找方案的核心理由，直接否定它。例如方案靠"快速验证"立论，反题就是"快速验证在此问题是伪需求，因为..."。
**怎么写合题**：要么修正方案吸收反题(如"快速验证前先加一道XX判断")，要么划边界("当XX成立时本方案失效，应转用YY")。

⛔ 反题和合题不是可选的装饰。没有经过反题的方案，等于没被自己的思维检验过。但这一步用自然语言，不出现"辩证法/正题反题"等术语。
