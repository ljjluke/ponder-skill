...
# Install (Codex)
# Terminal:
codex plugin marketplace add ljjluke/ponder-skill
codex plugin add ponder@luke
# In chat: "install ponder plugin from ljjluke/ponder-skill"

# Update (Codex)
# Terminal:
codex plugin marketplace upgrade luke
codex plugin remove ponder && codex plugin add ponder@luke
# In chat: "update ponder plugin from ljjluke/ponder-skill"
