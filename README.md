...
# Install (Codex)
# Terminal:
codex plugin marketplace add ljjluke/mcts-skill
codex plugin add ponder@luke
# In chat: "install ponder plugin from ljjluke/mcts-skill"

# Update (Codex)
# Terminal:
codex plugin marketplace upgrade luke
codex plugin remove ponder && codex plugin add ponder@luke
# In chat: "update ponder plugin from ljjluke/mcts-skill"
