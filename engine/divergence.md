...
## Phase 1.5: 视角互否 — 让六视互相撞击

六视如果只是六个并列的观察，那就是"六个单向视角"，不是思维运动。真正的运动发生在视角之间互相否定：鲲鹏看大局，蜩鸠看细节——但如果蜩鸠的细节推翻了鲲鹏的格局判断呢？朝菌说"立刻做"，冥灵说"这事百年后看无关紧要"——这两个直接对立，谁对？

**门控——先判断要不要做互否**：
- 可逆小事(取名/调参/晚饭) → 跳过互否，consensus 直接综合六视即可。
- 高赌注/复杂问题 → 必须做互否。这种问题里视角冲突不撞开，consensus 就是和稀泥。

六视产出后，进八卦镜前，做视角互否(高赌注问题才做):

```
① 找对立: 在六视里找出1-2对互相矛盾/对立的视角对(不要全配对,C(6,2)=15对会爆炸)
   - 不是随便配对，是找真冲突: 视A的结论如果成立，视B的结论就不成立
   - 典型对立: 宏观vs微观、短期vs长期、干预vs不干预、有我vs无我
   - 找不到真冲突的对(六视确实和谐)→ 说明问题可能太简单,记下这个信号

② 互否: 对每对，让双方互相质疑对方
   - 视A说: 视B的洞察在什么条件下是错的/盲的
   - 视B说: 视A的洞察在什么条件下是错的/盲的
   - 双方都不许退让到"其实我们都对"——必须指出对方哪里站不住
   - ⛔ 质疑要具体: 说"视B忽略了X情况下Y不成立"，不说"视B不够全面"这类软话

③ 合题: 吸收双方后，这个对立怎么解？
   - 不是折中("各对一半")，是找到让对立消失的更高一层
   - 或明确: 在什么条件下A对，什么条件下B对，边界在哪
```

**consensus 必须体现这个互否的产物**——不是六视的简单汇总，是经过撞击后存活的判断。如果 consensus 只是"六视各有道理"，说明互否没做（或做了但没撞开）。

**对象层级**：互否只谈"视角之间的冲突如何化解"，⛔不要上升到"所有方案共享什么前提"——那是综合阶段结论自反的活。

⛔ 对外输出用自然语言，不出现"辩证/正题反题"等术语。这一步是思维运动，不是哲学课。
